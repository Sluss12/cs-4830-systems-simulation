...
print("----------------------------------------\n")
plt.figure()
plt.hist(sampledInterarrivalTimes, bins=50)
...
print("----------------------------------------\n")
plt.figure()
plt.hist(sampledOrders, bins=50)
plt.xlabel('Order Time')
plt.ylabel('frequency')
plt.title('Sampled Order Times')
...
print("----------------------------------------\n")
plt.figure()
plt.hist(sampledPayments, bins=50)
plt.xlabel('Payments Time')
plt.ylabel('frequency')
plt.title('Sampled Payment Times')
...
print("----------------------------------------\n")
plt.figure()
plt.hist(sampledPickups, bins=50)
plt.xlabel('Pickup Time')
plt.ylabel('frequency')
plt.title('Sampled Pickup Times')
